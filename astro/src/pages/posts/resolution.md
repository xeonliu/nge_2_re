...
2023年的时候，看完了EVA的TV，久久不能释怀，就是在同时期，看到了B站UP主`Langley_D`的EVA2解说视频，感到很治愈，旋即想找来玩。
...
> ![Image](./assets/103_17807_eva20.jpg)
> 
> 2003年10月30日，EVA2（PS2）[完成纪念发布会](https://web.archive.org/web/20140826115327/http://www.famitsu.com/game/news/1143477_1124.html)

# 汉化

汉化，说的好听，其实就是逆向工程。逆向工程首要的就是要对处理器的指令集有了解，或者说就是看得懂汇编。现今的`x86-64`架构，或称`amd64`架构，大家都很熟悉了，指令集什么的也有了解。`PSP`的处理器是`MIPS`架构的，鉴于`MIPS`已经倒闭，许多人也只在书本上听说过它。尽管索尼有多台设备使用的是`MIPS`处理器。
