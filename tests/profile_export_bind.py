...
def profile_export_bind(output_dir: str = None, prefix: str = None):
    """
    Profile export_bind 操作
    ...
    try:
        # 执行导出操作
        App.export_bind(output_dir, prefix)
    finally:
        pr.disable()
...
if __name__ == '__main__':
    ...
    profile_export_bind(args.output, args.prefix)
