...
def profile_import_hgar(output_dir, file_path: str):
    """
    ...
    print(f"  Prefix: {sys.prefix if sys.prefix else '(all)'}")
    print("-" * 60)
...
if __name__ == '__main__':
    ...
    profile_import_hgar(args.output, args.prefix)
